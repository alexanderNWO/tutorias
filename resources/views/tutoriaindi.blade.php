			...
			<div class="col-xs-12 ">
				...
				<div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
					...
					<table>
						...
						<tr>
							<td width="100" height="50"></td>
							<td><input type="hidden" name="matricula" value="{{$d->matricula}}">
						...
						<tr>
							...
							<td ><input type="radio" name="tipo" value="Grupal" checked> Grupal <input type="radio" name="tipo" value="Individual"> Individual</td>
							<td width="100" height="50"></td>
						</tr>
						<tr>
							<td width="100" height="50"></td>
							<td>Descripción de la tutoria:</td>
							<td ><textarea rows="4" cols="50" name="descripcion" required></textarea></td>
							<td width="100" height="50"></td>
						</tr>
						<tr>
							<td width="100" height="50"></td>
							<td>Acciones:</td>
							<td ><textarea rows="4" cols="50" name="acciones" required></textarea> <input type="hidden" name="cesc" value="{{$ciclo->idcesc}}"></td>
							<td width="100" height="50"></td>
						</tr>
					...
					<div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
						...
						<table>
							...
							<tr>
								...
								<td><input type="date" name="siguiente" required></td>
								<td width="100" height="50"></td>
							</tr>
							<tr>
								<td width="100" height="50"></td>
								...
								<td><fieldset required>
									...
									<input type="radio" name="estatus" value="Activo" checked> A <input type="radio" name="estatus" value="Cancelado"> C <input type="radio" name="estatus" value="EProceso"> EP
					...
					<table>
						...
						<tr>
							<td width="100" height="50"></td>
							<td>Detalles</td>
							<td><textarea rows="4" cols="50" name="detalles" required></textarea></td>
							<td width="100" height="50"></td>
						</tr>
					</table>
					</center>
